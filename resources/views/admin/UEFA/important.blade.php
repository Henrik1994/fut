        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <h4 class="text-center">Important Page</h4>
                    <div class="col-sm-12">
                        ...
                        <div class="demo" id="important_demo" style="display: none!important;"><br>
                            <form action="{{ url('important_set') }}" method="post" enctype="multipart/form-data">
                            ...
                            @if(isset($importants))
                                @foreach($importants as $important)
                                    <div class="col-sm-4" style="padding-top: 10px">
                                        ...
                                        <a href="{{ url('/delete_important', $important->id) }}"><button type="button" class="btn btn-danger pull-right"><span class="glyphicon glyphicon-trash"></span></button></a>
                                        <button type="button" class="btn btn-success pull-right important_update" data-toggle="modal" data-target="#important_update" data-id="{{ $important->id }}" data-title="{{ $important->title }}" data-desc="{{ $important->description }}" data-img ="{{  asset("image/".$important->image)  }}"><span class="glyphicon glyphicon-edit"></span></button>
            ...
            <div class="modal-dialog modal-lg" >
                <div class="modal-content col-sm-12">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ url('/update_important') }}" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
