                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="more-sports">
                        <div class="more-sports-heading">
                            <h3 class="text-center">Results Page </h3>
                            ...
                            <div class="demo" id="results_demo" style="display: none!important;">
                                <form action="{{ url('results_set') }}" method="post" class="form-inline">
                        ...
                        <?php  $i = 1; ?>
                            ...
                            <table class="table table-bordered" style="border: 1px solid black">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $result->team2 }}</td>
                                    <td>
                                        <button type="button" class="btn btn-success results_update" data-toggle="modal" data-target="#results_update" data-id="{{ $result->id }}" data-team1="{{ $result->team1 }}" data-res1="{{ $result->res1 }}" data-res2 ="{{ $result->res2 }}" data-team2 ="{{ $result->team2 }}"><span class="glyphicon glyphicon-edit"></span></button>
                                        <a href="{{ url('/delete_results',$result->id) }}"><button type="button" class="btn btn-danger "><span class="glyphicon glyphicon-trash"></span></button></a>
                                    </td>
                                </tr>
                                    @endforeach
                                    @endif
                        ...
                        <div class="modal-dialog modal-lg" >
                            <div class="modal-content col-sm-12">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('update_results') }}" method="post" class="form-inline">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
