            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('/video') }}"><i class="fa fa-circle-o"></i> General Video</a></li>
                        <li><a href="{{ url('/news') }}"><i class="fa fa-circle-o"></i> News</a></li>
                        <li><a href="{{ url('/important') }}"><i class="fa fa-circle-o"></i> Important</a></li>
                        <li><a href="{{ url('/groups') }}"><i class="fa fa-circle-o"></i> Groups</a></li>
                        <li><a href="{{ url('/matches') }}"><i class="fa fa-circle-o"></i> Matches</a></li>
